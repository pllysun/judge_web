...
const getDifficultyLabel = (difficultyLevel) => {
  ...
  return (
    difficultyMap[difficultyLevel.level] || {
      difficulty: difficultyLevel.difficulty || '未知',
                ...
                <div>
                  ...
                  <div class="mt-2 flex items-center">
                    <span
                      ...
                      :class="problem.difficultyLabel.class"
                    >
            ...
            <div class="px-4 py-5 sm:p-6">
              <div class="prose max-w-none">
                ...
                <h4
                  ...
                  class="mt-6 text-lg font-medium text-gray-900"
                >
                  示例
                </h4>
                <pre
                ...
                <h4
                  v-if="problem.constraints && problem.constraints.length > 0"
                  class="mt-6 text-lg font-medium text-gray-900"
                >
                  提示
                </h4>
            ...
            <div class="px-4 py-5 sm:p-6">
              <ul class="divide-y divide-gray-200">
                <li class="py-3">
                  <div class="flex items-center justify-between">
                    <div>
                      <router-link to="/problems/15" class="text-indigo-600 hover:text-indigo-900"
                        >15. 三数之和</router-link
                      >
                      <span
                ...
                <li class="py-3">
                  <div class="flex items-center justify-between">
                    <div>
                      <router-link to="/problems/18" class="text-indigo-600 hover:text-indigo-900"
                        >18. 四数之和</router-link
                      >
                      <span
                        class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800"
